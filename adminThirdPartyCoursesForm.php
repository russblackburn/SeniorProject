...
// build the database connection with host, user, password, database
	...
	// build the query
	$query = "INSERT INTO thirdPartyCourse(courseTitle, paragraph1, paragraph2, paragraph3, paragraph4, paragraph5, paragraph6, paragraph7, paragraph8, paragraph9, paragraph10, listItem1, listItem2, listItem3, listItem4, listItem5, listItem6, listItem7, listItem8, listItem9, listItem10, listItem11, listItem12, listItem13, listItem14, listItem15, listItem16, listItem17, listItem18, listItem19, listItem20, registrationInstructions, linkTitle1, link1, linkTitle2, link2, linkTitle3, link3, photo, hide, slide_hidden)". 
...
<!-- end of the unordered list -->
  ...
  <button type="submit" class="btn btn-primary" name="submitButton">Add Third Party Course</button>
</form>
