<?php
	...
	if(isset($_POST['submitButton'])){
		...
		$feedback = '<p class="adminGreen">The Instructor Registration has been updated. <a href="instructorRegistration.php">&#8617; View INSTRUCTOR REGISTRATION Page</a></p>';
	}//end of if submit/isset
	
	// build the query to display the current mission statement
	$query01 = "SELECT * FROM register WHERE id='2'";
