...
<p><a href="adminVideoGalleryUpdateVideo.php">Select the Video's Category</a> > Select the Video's Subcategory</p>
...
while($row = mysqli_fetch_array($result)){
	...
	echo ' <a href="adminVideoGalleryUpdatePhotoStep3.php?id='. $row['id'].'&n1='.$category_id.'">[select]</a>';
	echo'</p>';
	};
?>
