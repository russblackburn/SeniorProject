...
if(isset($_POST['submitButton']))
	...
	$query01 = "SELECT * FROM videoCategory WHERE id=$category_id";
...
<div class="form-group">
  ...
  <button type="submit" class="btn btn-primary" name="submitButton">Update <?php echo $found['category']; ?></button>
</form>
