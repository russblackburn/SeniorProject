...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" name="update_research">
  ...
  <div class="form-group">
    <label for="paragraph1" data-toggle="popover" title="Paragraph 1" data-content="First paragraph for the page. Must have at least one paragraph. This is a description for the research page.">Paragraph 1</label>
  ...
  <button type="submit" class="btn btn-primary" name="submitButton">Update Research</button>
</form>
