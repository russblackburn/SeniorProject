...
while($row1 = mysqli_fetch_array($result1)){
	...
	echo ' <a href="adminEventUpdateDetail.php?id='. $row1['id'].'">[update]</a>';
	echo'</p>';
	};
?>
...
while($row2 = mysqli_fetch_array($result2)){
	...
	echo ' <a href="adminEventUpdateDetail.php?id='. $row2['id'].'">[update]</a>';
	echo'</p>';
	};
?>
...
while($row3 = mysqli_fetch_array($result3)){
	...
	echo ' <a href="adminEventUpdateDetail.php?id='. $row3['id'].'">[update]</a>';
	echo'</p>';
	};
?>
