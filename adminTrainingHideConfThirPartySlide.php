...
$query = "SELECT * FROM thirdPartyCourse WHERE id=$research_id";
...
if(isset($_POST['submitButton']))
	...
	$hide = mysqli_real_escape_string($dbc, trim($_POST[hide]));
		...
		//build the query
		$query = "UPDATE thirdPartyCourse SET slide_hidden='$hide' WHERE id=$id ";
...
<p><?php echo $found['courseTitle'];?> slide is currently <?php if($found['slide_hidden'] == T){ echo 'hidden';}else{echo 'visible';} ?></p>
