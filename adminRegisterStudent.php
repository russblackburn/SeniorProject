<?php
	...
	if(isset($_POST['submitButton'])){
		...
		$feedback = '<p class="adminGreen">The Student Registration has been updated. <a href="studentRegistration.php">&#8617; View STUDENT REGISTRATION Page</a></p>';
	}//end of if submit/isset
	
	// build the query to display the current mission statement
	$query01 = "SELECT * FROM register WHERE id='1'";
...
$page = admin;
$adminPage = register;
$adminSecondaryPage = register1;
?>
<?php require_once('header.php'); ?>

<h1>Update Student Registration Description</h1>
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" name="update_student_registration">
