...
if(isset($_POST['submitButton']))
	...
	if($_FILES['photo']['size'] == 0){
		...
		$feedback = '<p class="adminGreen">'.$subcategory.' has been updated. <a href="videosSubcategory.php?id='.$found['id'].'">&#8617; View Video Subcategory</a></p>';
		}
	...
	$query01 = "SELECT * FROM videoSubcategory WHERE id=$category_id";
...
<div class="form-group">
  ...
  <button type="submit" class="btn btn-primary" name="submitButton">Update <?php echo $found['subcategory']; ?></button>
</form>
